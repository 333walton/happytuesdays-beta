...
const VideoPlayerMobile = (props) => {
    ...
    if (progressRef.current && videoRef.current) {
      ...
      if (progressThumbRef.current) {
        const positionPx = Math.max(
          0,
          Math.min(position * effectiveWidth, effectiveWidth)
        );
  ...
  const buttonList = [
    ...
    { type: "open", className: "open", action: handleOpen },
    {
      ...
      action: handleSeekBackward,
    },
    {
      type: "seekforward",
      className: "seekforward",
      action: handleSeekForward,
    },
    ...
    >
      ...
      >
        ...
        <div className="wmp-shell">
          ...
          >
            <span ref={timeDisplayRef} className="wmp-time-text">
              00:00
            </span>
          </div>
          ...
          >
            VAST Inspector & Video Ad Tag Tester
          </span>
          <span
            className="wmp-info-text"
            style={{
