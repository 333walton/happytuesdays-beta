...
const DesktopControlsContent = () => {
  ...
  return (
    <div className="desktop-controls-container">
      ...
      >
        {assistantVisible ? (
          <img src="/static/Textchat_16x16_4.png" alt="Chat Icon" style={{ width: '16px', height: '16px' }} />
        ) : (
...
const DesktopControls = () => {
  ...
  useEffect(() => {
    ...
    const injectVisibilityStyles = () => {
      const existingStyle = document.getElementById("desktop-clippy-visibility");
      if (existingStyle) {
    ...
    return () => {
      ...
      const visibilityStyle = document.getElementById("desktop-clippy-visibility");
      if (visibilityStyle) {
