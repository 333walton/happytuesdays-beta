 ...
 * Always shows chat balloon
 */
export function handleMobileLongPress({ showChatBalloon }) {
  devLog("Mobile long press - showing chat balloon");

  setTimeout(() => {
    if (window.showClippyChatBalloon) {
      window.showClippyChatBalloon("Hi! What would you like to chat about?");
      devLog("Chat balloon shown via global function");
    } else {
      showChatBalloon("Hi! What would you like to chat about?");
      devLog("Chat balloon shown via direct call");
    }
  }, 100);
